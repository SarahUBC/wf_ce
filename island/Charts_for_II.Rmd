...
ns <- ggplot(ar, aes(x = Opinion, y = Response, fill = Opinion))+
  ...
  scale_fill_viridis(discrete=TRUE, "Opinion") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  xlab("Opinion") + ylab("Response (%)") +
  ggtitle("Do you think that making electricty from wind\nis a good idea, a bad idea, or neither good nor bad?")
...
myColors2 <- c("brown3", "blue3", "goldenrod", "darkgreen", "darkorchid4")
